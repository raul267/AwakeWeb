...
/*
	public static function Conn()
		{
			$conn = new PDO('mysql:host=www.tecnoactive.cl;dbname=tecnoact_awake','tecnoact_practic','rF1_w6NOrwby',array(PDO::MYSQL_ATTR_INIT_COMMAND=>'SET NAMES \'UTF8\''));
			$conn -> setAttribute(PDO::ATTR_ERRMODE,PDO::ERRMODE_EXCEPTION);
			return $conn;
		}
	}
	define('DB_HOST','www.tecnoactive.cl');
	define('DB_NAME','tecnoact_awake');
