                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-9">
                                    <div class="user-profile-content">
                                        ...
                                        <br><h5>Edificio:</h5><label><?php if ($u->idEdificio != null)
                                        {
                                          echo $u->idEdificio;
                                        }else
                                        {
                                          echo " No esta asignado a un edificio";
                                        } ?></label>
                                    </div>
                                </div>
                            </div>
...
<div class="user-prfile-activity-area mg-b-40 mg-t-30">
    <div class="container-fluid">
      <div class="row">
        <?php foreach ($c->ListarComentarios($_SESSION['id']) as $row): ?>
