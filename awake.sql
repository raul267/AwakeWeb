...
-- Script date 03-05-2019 9:51:56
...
(1, 'Raul Strappa', '18935801-6', '941512', 'raul.strappa94@gmail.com', NULL, 'Santa Rita 699', 109, 7, 'Chilena/o', 'assets/img/perfil/18935801-6.jpg', '1994-12-15', '05/02/2019 5:38pm', 0, '+56966576370', 1, NULL),
(11, 'Kilian Jones', '8612090-9', '941512', 'ki.jones@gmail.com', 1, 'Manquehue 12', 11, 10, 'Neverlandiano', 'assets/img/perfil/8612090-9.jpg', '2019-04-16', '04/06/2019 12:33am', 2, '+56977638173', 1, 'Pirata'),
(14, 'Barney Stinson', '6376008-0', '941512', 'r.strappa@alumnos.duoc.cl', 2, 'dasdasd', 2, 2, 'Chilena/o', 'assets/img/perfil/6376008-0.j', '1992-12-14', '04/11/2019 1:32pm', 2, '+56977638173', 1, 'Legend ... wait for it ... .dary'),
(26, 'Prueba', '18232232-6', '12345678', 'asdad', NULL, 'asdasd', 14, 3, 'Chilena/o', 'assets/img/perfil/18232232-6.jpg', '2019-01-01', '04/26/2019 11:07am', 4, '+56977638173', 1, 'sdsd');

-- 
-- Dumping data for table user_comunicaciones
--
-- Table tecnoact_awake.user_comunicaciones does not contain any data (it is empty)
...
(1, NULL, 1, 'Viajar en el tiempo a esa fecha y hora ', '2091-03-14 00:00:00', 0);
...
--
-- Table tecnoact_awake.mensajes does not contain any data (it is empty)
...
(2, 2, 'los pumas', 'los pumas 12006', 7, 109),
(3, 21, 'Navarra', 'Navarra 3720', 7, 109),
(4, 21, 'TEST!', 'Cerro 5555', 7, 109);

-- 
-- Dumping data for table comunicaciones
--
INSERT INTO comunicaciones VALUES
(1, 'Querida comunidad: \r\n\r\nEste es un mensaje de prueba, no olviden que mañana es viernes y esta estrictamente prohibido no hacer ruido. \r\n\r\nMuchas gracias\r\n\r\nLa administración', 1, '04/11/2019 7:40pm');
...
(11, 11, 3, 1, 'asdsads', '2019-04-09', 7),
...
(16, 11, 3, 1, 'asdsads', '2019-04-09', 3),
...
(23, 11, 3, 1, 'asdsads', '2019-04-09', 7),
(24, 11, 4, NULL, NULL, '2019-04-09', 10),
(25, 11, 3, 1, 'asdsads', '2019-04-09', 10),
(26, 14, 1, NULL, NULL, '2019-04-11', 4),
(27, 14, 1, NULL, NULL, '2019-04-11', 3),
(28, 14, 1, NULL, NULL, '2019-04-11', 4),
(29, 14, 1, NULL, NULL, '2019-04-11', 7),
(30, 14, 2, NULL, NULL, '2019-04-11', 10),
(31, 14, 3, 1, 'asdsads', '2019-04-11', 9),
(32, 14, 3, 1, 'asdsads', '2019-04-11', 4),
(33, 14, 1, NULL, NULL, '2019-04-11', 4),
(34, 14, 4, NULL, NULL, '2019-04-11', 1),
(35, 14, 4, NULL, NULL, '2019-04-11', 3),
(36, 14, 1, NULL, NULL, '2019-04-11', 5),
(37, 14, 2, NULL, NULL, '2019-04-11', 10);

-- 
-- Dumping data for table alarma
--
INSERT INTO alarma VALUES
(1, 1, '2019-04-13 04:23:00', NULL, 0, NULL);
