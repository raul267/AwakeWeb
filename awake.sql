...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-03-2019 a las 15:31:33
...
CREATE TABLE `usuario` (
  ...
  `tipoUsuario` int(4) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `usuario` (`idUsuario`, `nombre`, `rut`, `password`, `correo`, `idComunidad`, `direccion`, `idComuna`, `idRegion`, `Nacionalidad`, `fotoPerfil`, `fechaNacimiento`, `ultimaConexion`, `tipoUsuario`) VALUES
(1, 'Raul Strappa', '18935801-6', '941512', 'raul.strappa94@gmail.com', NULL, 'Santa Rita 699', 109, 7, 'Chilena/o', 'assets/img/perfil/18935801-6.j', '1994-12-15', NULL, 0);
